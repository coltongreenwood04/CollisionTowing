            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex items-start gap-2">
                ...
                <div className="text-sm text-muted-foreground">
                  ...
                  <div>Eden, Utah</div>
                  <div className="mt-2 font-medium text-foreground">West Jordan Office:</div>
                  <div>8415 S 4300 W, West Jordan, UT</div>
                  <div className="text-xs">(Yard #10950)</div>
                  <div className="mt-2 font-medium text-foreground">Ogden Office:</div>
                  <div>3275 Wall Ave, Ogden, UT 84401</div>
                  <div className="text-xs">(Yard #10717)</div>
                  <div className="mt-2 font-medium text-foreground">Murray Storage Yard:</div>
                  <div>5662 S. 300 W. Murray UT 84107</div>
                  <div className="text-xs">(Yard #10557 - No Office)</div>
                </div>
              </div>
              <div className="flex items-start gap-2">
